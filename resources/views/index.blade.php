...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
                ...
                <div class="inputOuter" id="uArea">
                    ...
                    <input type="text" id="u" name="phone" class="inputstyle"/>
                </div>
                </div>
               ...
               <div class="inputOuter" id="pArea">
                ...
                <div style="padding-left:50px;margin-top:20px;"><input type="submit" value="登 录" style="width:150px;" class="button_blue" id="submit_button"/></div>
              </form>
           </div>
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="{{url('/register')}}" method="post">
            {{csrf_field()}}
        <ul class="reg_form" id="reg-ul">
                ...
                <li>
                    ...
                    <div class="inputOuter2">
                        <input type="text" id="user" name="phone" maxlength="16" class="inputstyle2"/>
                    </div>
